...
ada_svr_reg_mse = mean_squared_error(ri_PaintingLT_labels_test, ri_PaintingLT_predicted)
ada_svr_reg_rmse = np.sqrt(ada_svr_reg_mse)
print(ada_svr_reg_rmse)

from sklearn.metrics import mean_absolute_error
ada_svr_reg_mae = mean_absolute_error(ri_PaintingLT_labels_test, ri_PaintingLT_predicted)
print(ada_svr_reg_mae)

ada_svr_reg_mape = (np.abs((ri_PaintingLT_predicted - ri_PaintingLT_labels_test) / ri_PaintingLT_labels_test).mean(axis=0))
print(ada_svr_reg_mape)

from sklearn.metrics import mean_squared_log_error
ri_PaintingLT_predicted[ri_PaintingLT_predicted<0] = 0
ada_svr_reg_rmsle = np.sqrt(mean_squared_log_error(ri_PaintingLT_labels_test, ri_PaintingLT_predicted))
