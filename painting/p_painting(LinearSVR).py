...
svm_reg_mse = mean_squared_error(ri_PaintingLT_labels_test, ri_PaintingLT_predicted)
svm_reg_rmse = np.sqrt(svm_reg_mse)
print(svm_reg_rmse)

from sklearn.metrics import mean_absolute_error
svm_reg_mae = mean_absolute_error(ri_PaintingLT_labels_test, ri_PaintingLT_predicted)
print(svm_reg_mae)

svm_reg_mape = (np.abs((ri_PaintingLT_predicted - ri_PaintingLT_labels_test) / ri_PaintingLT_labels_test).mean(axis=0))
print(svm_reg_mape)

from sklearn.metrics import mean_squared_log_error
svm_reg_rmsle = np.sqrt(mean_squared_log_error(ri_PaintingLT_labels_test, ri_PaintingLT_predicted))
print(svm_reg_rmsle)
